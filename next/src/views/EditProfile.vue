            ...
            <form>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                    <div class="text-center mb-4">
                        <button class="bg-green-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded w-64" @click.prevent="update(); toProfile()">
                        Update
                        </button>
                    </div>
                    <div>
                        <button class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded w-64" @click.prevent="toProfile">
                        Cancel
                        </button>
                    </div>
                </div>
