            ...
            <div class="flex items-center justify-center min-h-screen pt-4 pb-20 text-center">
                ...
                <div class="inline-block align-bottom bg-purple-900 rounded-lg overflow-hidden shadow-xl transform transition-all max-w-lg mx-6 p-5">
                    ...
                    <div class="text-center space-x-6">
                        ...
                        <p class="text-white mb-3">{{this.modalMessage}}</p>

                        <the-button @click="$emit('confirm',true);$emit('closeModal')" class="bg-green-500 hover:bg-green-700 text-white" buttonType="form-sm">
                            CONFIRM
                        </the-button>

                        <the-button @click="$emit('confirm',false);$emit('closeModal')" class="bg-red-500 hover:bg-red-700 text-white mt-3" buttonType="form-sm">
                            CANCEL
                        </the-button>
