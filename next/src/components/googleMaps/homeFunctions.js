...
export default {
  ...
  computed: {
    ...
    showLastCheckedIn() {
      ...
      if (
        typeLastCheckedInCourtID == "null" ||
        typeLastCheckedInCourtID == "undefined" ||
        lastCheckedInCourtID == "" ||
        lastCheckedInCourtID == null ||
        lastCheckedInCourtID == undefined
      ) {
        return false;
      }
      return true;
    ...
    searchForNearbyCourts() {
      ...
      var map = new google.maps.Map(this.$refs.mapDiv, {
        center: new google.maps.LatLng(
          this.defaultPos.latitude,
          this.defaultPos.longitude
        ),
        zoom: 14,
      });
